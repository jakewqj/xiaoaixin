...
/**
 * 小金(幼年金鲹)跟在小爱心身后的几何。他按「跟随小爱心」落位,
 * 没有固定地点 —— 渲染层每帧从他的当前位置算跟随目标。
 * gap = 从她身体外缘再留出的一段,免得小爱心长大了小金还贴在她身上;
 * drop = 让他游得比身子中央略低一点,才像「跟在后面」不是「飘在旁边」;
 * ease = 每帧向目标靠拢的比例,小爱心转身时他平滑绕过去,而不是啪地换边。
 */
export const FOLLOW = { gap: 26, drop: 14, ease: 0.12 } as const
