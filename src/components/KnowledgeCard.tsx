...
function KnowledgeCard({ card, onDismiss }: KnowledgeCardProps) {
  return (
    <button
      ...
      onClick={onDismiss}
      aria-label="收起"
      className="knowledge-card pointer-events-auto absolute bottom-16 left-0 max-w-[340px] cursor-pointer rounded-r-xl border-2 border-l-0 border-wood-dark bg-parchment/95 py-4 pr-6 pl-5 text-left shadow-xl focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-heart"
    >
